...
class MypokemonAdapter(var dataList : ArrayList<MypokemonData>) : RecyclerView.Adapter<MypokemonViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MypokemonViewHolder, position:  Int) {
        holder.poke_name.text = dataList!!.get(position).poke_name
    }
